...
const mockNotifications = [
  { type: "danger", title: "Этап просрочен!", subtitle: "Проект: Рога и копыта" },
  { type: "info", title: "Загружена новая версия файла" },
  { type: "warning", title: "Изменен срок проекта" },
];
...
export default function DesignerNotifications() {
  ...
  const totalPages = useMemo(() => Math.max(1, Math.ceil(mockNotifications.length / PAGE_SIZE)), []);
